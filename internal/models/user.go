...
type User struct {
	...
	TwoFactorOn  int8      `json:"two_factor_on" gorm:"column:two_factor_on;not null;default:0"`
	...
	IsAdmin      int8      `json:"is_admin" gorm:"not null;default:0"`
	Status       Status    `json:"status" gorm:"not null;default:1"`
	BaseModel    `json:"-" gorm:"-"`
}
